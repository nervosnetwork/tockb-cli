...
test-sudt:
	${TOCKB_CLI} sudt transfer --kind 1 --privkey-path privkeys/0 --tx-fee 0.1 --to ckb1qyqy5vmywpty6p72wpvm0xqys8pdtxqf6cmsr8p2l0 --sudt-amount 1 --ckb-amount 200
	${TOCKB_CLI} sudt get_balance --kind 1 --addr ckb1qyqy5vmywpty6p72wpvm0xqys8pdtxqf6cmsr8p2l0
